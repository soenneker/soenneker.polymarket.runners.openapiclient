[![](https://img.shields.io/github/actions/workflow/status/soenneker/Soenneker.Polymarket.Runners.OpenApiClient/build-and-test.yml?style=for-the-badge)](https://github.com/soenneker/Soenneker.Polymarket.Runners.OpenApiClient/actions/workflows/build-and-test.yml)
[![](https://img.shields.io/github/actions/workflow/status/soenneker/Soenneker.Polymarket.Runners.OpenApiClient/daily-automatic-update.yml?style=for-the-badge&label=Daily%20Update)](https://github.com/soenneker/Soenneker.Polymarket.Runners.OpenApiClient/actions/workflows/daily-automatic-update.yml)

# Soenneker.Polymarket.Runners.OpenApiClient
